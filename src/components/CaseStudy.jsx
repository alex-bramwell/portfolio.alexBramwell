...
const PROCESS_STEPS = [
  ...
  { phase: "03", title: "Design System", detail: "Built a token-based system: colour, spacing, type scales, so every tenant can be rebranded from config. Components documented in Storybook.", links: [{ href: "FIGMA_URL", label: "Open the Figma" }, { href: "https://alex-bramwell.github.io/nosweat/?path=/docs/common-animatedsection--docs", label: "Browse the Storybook" }] },
